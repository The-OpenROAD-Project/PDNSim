...
private:
    ...
    //void temp_compare_gmat() {
    //    int nnz =0;
    //    std::vector<double> a_vec; //non zero values
    //    std::vector<int> asub_vec; //row pointer
    //    std::vector<int> xa_vec; //col pointer
    //    int col_i,col_num;
    //    col_num =0;
    //    int m=1877;
    //    for(int i =0 ;i<m_G_mat.size();++i) {
    //        if(i%m ==0){
    //            xa_vec.push_back(col_num);
    //        }
    //        if(m_G_mat[i] != 0){
    //            a_vec.push_back(m_G_mat[i]);
    //            asub_vec.push_back(i%m);
    //            col_num++;
    //        }
    //    }
    //    xa_vec.push_back(col_num);
    //    nnz= col_num;
    //    cout<<"nnz 1 "<<nnz<<" 2 "<<m_G_mat_csc.nnz<<endl;
    //    for(int i =0 ; i<nnz;++i){
    //        if((a_vec[i]- m_G_mat_csc.values[i])<1e-5){
    //        } else {
    //            cout<<"difference at node "<<i<<" values "<<a_vec[i]<<" "<<m_G_mat_csc.values[i]<<endl;
    //        }
    //        if(asub_vec[i]== m_G_mat_csc.row_idx[i]){
    //        } else {
    //            cout<<"difference at node "<<i<<" row_idx "<<asub_vec[i]<<" "<<m_G_mat_csc.row_idx[i]<<endl;
    //        }
    //    }
    //    for(int i =0 ; i<1878;i++) {
    //        if(xa_vec[i]== m_G_mat_csc.col_ptr[i]){
    //        } else {
    //            cout<<"difference at node "<<i<<" col_ptr"<<xa_vec[i]<<" "<<m_G_mat_csc.col_ptr[i]<<endl;
    //        }
    //        
    //    }
...
private:
    ...
    void m_readC4Data() {
        std::ifstream file("../c4BumpLoc.txt"); //TODO read file as an input 
	    std::string line = "";
...
//    //cout<<" col_prt "<<col_ptr[1877]<<" "<<endl;
//    //for(int i=0; i<1878;i++) {
//    //    cout<<col_ptr[i]<<endl;
//    //}
//    //for(int i=0; i<col_ptr[1877];i++) {
//    //    cout<<values[i]<<endl;
//    //}
//
//    dCreate_CompCol_Matrix(&A, m, n, nnz, values, row_idx, col_ptr, SLU_NC, SLU_D, SLU_GE);
...
int main() {
    ...
    gmat_obj = new irsolver::GMat(7,1);
    std::cout<<"New_obj\n";
