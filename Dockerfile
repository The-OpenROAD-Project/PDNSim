...
COPY --from=builder /PDNA/build/PDNA /build/PDNA
COPY --from=builder /PDNA/module/OpenSTA/app/sta /build/sta
COPY --from=builder /PDNA/test/PORT9.dat /build/share/PORT9.dat
COPY --from=builder /PDNA/test/POST9.dat /build/share/POST9.dat
COPY --from=builder /PDNA/test/POWV9.dat /build/share/POWV9.dat
